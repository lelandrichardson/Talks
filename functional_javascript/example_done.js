...
var stringFormat = variadic(function(template, /* ... */ params){
...
//
var isUndefined = curry(op["==="], undefined);
var isDefined = compose(op["!"], isUndefined); // or curry(op["!=="],undefined);
...
var sortAsc = sort(op["<"]); //compose(sort,comparator)(compareNumbers);
