define(["knockout", "section"], function(ko, Section) {
    ...
    return function() {
        ...
        this.sections = ko.observableArray([
            ...
            new Section({name: "Title", template: "FullSlide"}),
            new Section({name: "Welcome", template: "FullSlide"}),
            new Section({name: "Information", template: "FullSlide"}),
...
//            new Section({name: "HelloWorld", template: "meme"}),
            new Section({name: "Introduction", template: "transition"}),
...
//            new Section({name: "WorkingWithServer", template: "sample"}),
            ...
            new Section({name: "Sponsors", template: "FullSlide"}),

            new Section({name: "Feedback", template: "FullSlide"}),
