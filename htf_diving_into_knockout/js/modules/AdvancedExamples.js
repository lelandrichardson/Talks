...
function(ko, Sample, $) {
    ...
    return new Sample("Extending Knockout", "AdvancedExamples", [
        ...
        new Sample.State("Writeable Computed Observables","02_matchpattern_01b", { hideResult: false, hideHtml: false}),
        ...
        new Sample.State("Building Observable Extensions","02_matchpattern_05", { hideResult: false, hideHtml: false}),
